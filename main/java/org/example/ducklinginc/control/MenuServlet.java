...
public class MenuServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        for(Receipt receipt: receiptlist){
            out.println("<br>" + receipt.getId() + ") Titel: " + receipt.getTitle() + " Date: " + receipt.getDate() + " Description: " + receipt.getDescription() + " Category: " + receipt.getCategory() + " Cost: " + receipt.getPrice()+"SEK");
        }
